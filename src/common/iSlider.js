...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory()
        ...
        : (global = global || self, global.iSlider = factory())
}(this, function () {
  'use strict'
  ...
  iSlider._animateFuncs = {
    ...
    var self = this
      ...
      return true
         ...
         * @private
         */
        self.isLooping = !!(opts.isLooping && self.data.length > 1);
    ...
    self.dampingForce = Math.max(0, Math.min(1, parseFloat(opts.dampingForce) || 0))
         ...
         * @private
         */
        self.isAutoplay = !!(opts.isAutoplay && self.data.length > 1);
  ...
  iSliderPrototype.has = function (eventName, func) {
    if (eventName in this.events) {
      return this.events[eventName].indexOf(func) > -1;
    }
    return false
    };
